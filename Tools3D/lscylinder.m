 function varargout = lscylinder(X, x0, a0, r0, tolp, tolg, w)
%      output: [x0n, an, rn, d, sigmah, conv, Vx0n, Van, urn, GNlog, a, R0, R]
% ---------------------------------------------------------------------
% LSCYLINDER.M   Least-squares cylinder using Gauss-Newton.
%
% Version 1.0  
% Amendment      L.W. Feb 2018 - only added variable argument output
...
% derivatives of rn 
  ...
  varargout = {x0n, an, rn, d, sigmah, conv, Vx0n, Van, urn, GNlog, a, R0, R};
% ---------------------------------------------------------------------
% End of LSCYLINDER.M.