...
function T_new = LeastSquaresPose(markers,T_init)
% Updated April 17th, 2016 to have only two dimensions in the marker
% variable, previous version is LeastsSquaresPose_3dim - doesn't work
% necessarily so use older version
% markers is a 3D vector with xyz in rows 1-3,marker number in 
%column

% Based on Challis et al. (1995)
